...
export type AttractionProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;
...
export type ProductItemCollectionHandleFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title' | 'tags' | 'availableForSale' | 'totalInventory'
> & {
...
> & {
  ...
  sellingPlanAllocations: {
    nodes: Array<{
      ...
      > & {
        billingPolicy?: StorefrontAPI.Maybe<
          Pick<
            StorefrontAPI.SellingPlanRecurringBillingPolicy,
            'interval' | 'intervalCount'
          >
        >;
        deliveryPolicy?: StorefrontAPI.Maybe<
          Pick<
            StorefrontAPI.SellingPlanRecurringDeliveryPolicy,
            'interval' | 'intervalCount'
          >
        >;
